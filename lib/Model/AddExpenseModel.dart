...
class AddExpenseModel {
    ...
    AddExpenseModel({this.classType, this.receiver, this.account_id, this.cost, this.date_submited, this.description, this.expense_type_id, this.gst, this.picture, this.response_code, this.response_description});
